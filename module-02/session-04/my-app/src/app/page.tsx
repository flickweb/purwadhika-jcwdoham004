      ...
      <div className="flex flex-col justify-center z-10 m-[70px]">
        <div className="flex flex-col h-[650px] w-[540px] justify-between">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row items-center bg-[#ffffff] border-b border-black h-[64px] w-[100%] gap-5 px-4 text-[18px] rounded-md">
              <Checkbox id="newCode" />
            ...
            <div className="flex flex-col bg-[#ffffff] h-[439px] w-[100%] rounded-md drop-shadow-xl">
              <div className="flex flex-row items-center basis-1/7 border-b border-black gap-5 px-4 text-[18px]">
                <Checkbox id="newCode" />
                <Label htmlFor="newCode">Create a new todo..</Label>
              </div>
              <div className="flex flex-row items-center basis-1/7 border-b border-black gap-5 px-4 text-[18px]">
              ...
              <div className="flex flex-row items-center justify-between basis-1/7 px-4 text-[14px] text-[#9495A5]">
